    ...
    public void update() {
        ...
        while(var1.hasNext()) {
            ...
            if (c.type == AbstractCard.CardType.ATTACK) {
                ...
                addToBot((AbstractGameAction) new ApplyPowerAction((AbstractCreature) AbstractDungeon.player, (AbstractCreature) AbstractDungeon.player, (AbstractPower) new DexterityPower((AbstractCreature) AbstractDungeon.player, this.mNumber), this.mNumber));

    ...
    public void update() {
        ...
        while(var1.hasNext()) {
            ...
            if (c.type == AbstractCard.CardType.SKILL) {
                ...
                addToBot((AbstractGameAction) new ApplyPowerAction((AbstractCreature) AbstractDungeon.player, (AbstractCreature) AbstractDungeon.player, (AbstractPower) new StrengthPower((AbstractCreature) AbstractDungeon.player, this.mNumber), this.mNumber));

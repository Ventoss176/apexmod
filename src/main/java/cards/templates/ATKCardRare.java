 ...
 * Description:
 **/
public class ATKCardRare extends CustomCard {
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings("ATKCardRare");
    public static final String NAME = cardStrings.NAME;
    public static final String DESCRIPTION = cardStrings.DESCRIPTION;
    public static final String UPGRADED_DESCRIPTION = cardStrings.UPGRADE_DESCRIPTION;
    public static final String IMG_PATH = "img/cards_Apex/ATKCardRare.png";
    private static final int COST = 1;
    private static final int ATTACK_DMG = 7;
    private static final int UPGRADE_PLUS_DMG = 2;
    public static final String ID = "ATKCardRare";
    public ATKCardRare() {
    ...
    public AbstractCard makeCopy() {
        //复制卡牌时触发
        return (AbstractCard)new ATKCardRare();
    }

...
import powers.SheathLimitPower;
...
public class Almighty extends CustomCard {
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot((AbstractGameAction) new ApplyPowerAction(p,p, new SheathLimitPower(p, this.magicNumber), this.magicNumber));
        ...
        addToBot((AbstractGameAction) new ApplyPowerAction(p,p, new SheathPower(p, this.magicNumber), this.magicNumber));
